...
tar xzf ~/actions-runner/actions-runner-linux-arm64-2.304.0.tar.gz
rm ~/actions-runner/actions-runner-linux-arm64-2.304.0.tar.gz
~/actions-runner/config.sh --url https://github.com/johnmj/dapps/ --token \$runner_token --name "Github EC2 Runner" --unattended
